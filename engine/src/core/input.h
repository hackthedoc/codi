...
#define DEFINE_KEY(name, code) CODI_KEY_##name = code
...
CAPI b8 CODI_IsKeyDown(const CODI_Key key);
CAPI b8 CODI_IsKeyUp(const CODI_Key key);
CAPI b8 CODI_WasKeyDown(const CODI_Key key);
CAPI b8 CODI_WasKeyUp(const CODI_Key key);
